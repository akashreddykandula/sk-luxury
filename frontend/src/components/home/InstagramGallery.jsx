...
const photos = [
  ...
  'https://images.unsplash.com/photo-1594938298603-c8148c4b4432?w=400&q=80',
  'https://images.unsplash.com/photo-1573408301185-9519f94f9b84?w=400&q=80',
      ...
      <div className="page-container">
        ...
        <div className="grid grid-cols-3 md:grid-cols-6 gap-2 md:gap-3">
          {photos.map((photo, i) => (
            ...
            >
              <img src={photo} alt={`SK Luxury Instagram ${i + 1}`}
              ...
              <div className="absolute inset-0 bg-emerald-950/0 group-hover:bg-emerald-950/50 transition-colors duration-300 flex items-center justify-center">
                <FaInstagram className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-300" size={22} />
              </div>
            </motion.a>
          ))}
        </div>
